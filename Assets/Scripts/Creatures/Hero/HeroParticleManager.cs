...
public class HeroParticleManager : MonoBehaviour
{
    ...
    [SerializeField] private PoolObjectSpawnComponent _attack2Particle;
    [SerializeField] private PoolObjectSpawnComponent _attack3Particle;
    ...
    public void CreateAttack2Particle()
    {
        _attack2Particle.Spawn();
    }
    public void CreateAttack3Particle()
    {
        _attack3Particle.Spawn();
    }
